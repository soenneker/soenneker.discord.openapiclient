...
namespace Soenneker.Discord.OpenApiClient.Applications.Item.Guilds.Item.Commands.Permissions
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Discord.OpenApiClient.Applications.Item.Guilds.Item.Commands.Permissions.PermissionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Soenneker.Discord.OpenApiClient.Models.CommandPermissionsResponse>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Discord.OpenApiClient.Models.CommandPermissionsResponse>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.Discord.OpenApiClient.Models.CommandPermissionsResponse>(requestInfo, global::Soenneker.Discord.OpenApiClient.Models.CommandPermissionsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Discord.OpenApiClient.Applications.Item.Guilds.Item.Commands.Permissions.PermissionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Discord.OpenApiClient.Applications.Item.Guilds.Item.Commands.Permissions.PermissionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Discord.OpenApiClient.Applications.Item.Guilds.Item.Commands.Permissions.PermissionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
