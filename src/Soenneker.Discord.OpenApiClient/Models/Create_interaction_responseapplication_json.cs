...
namespace Soenneker.Discord.OpenApiClient.Models
{
    ...
    public partial class Create_interaction_responseapplication_json : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Discord.OpenApiClient.Models.Create_interaction_responseapplication_json"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Discord.OpenApiClient.Models.Create_interaction_responseapplication_json CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.Discord.OpenApiClient.Models.Create_interaction_responseapplication_json();
