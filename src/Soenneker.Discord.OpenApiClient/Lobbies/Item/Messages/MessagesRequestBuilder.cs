...
using Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.Item;
...
namespace Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages
{
    ...
    public partial class MessagesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.MessagesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Soenneker.Discord.OpenApiClient.Models.LobbyMessageResponse>?> GetAsync(Action<RequestConfiguration<global::Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.MessagesRequestBuilder.MessagesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Discord.OpenApiClient.Models.LobbyMessageResponse>> GetAsync(Action<RequestConfiguration<global::Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.MessagesRequestBuilder.MessagesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.Discord.OpenApiClient.Models.LobbyMessageResponse>(requestInfo, global::Soenneker.Discord.OpenApiClient.Models.LobbyMessageResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        public async Task<global::Soenneker.Discord.OpenApiClient.Models.LobbyMessageResponse> PostAsync(global::Soenneker.Discord.OpenApiClient.Models.SDKMessageRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Discord.OpenApiClient.Models.LobbyMessageResponse>(requestInfo, global::Soenneker.Discord.OpenApiClient.Models.LobbyMessageResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.MessagesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.MessagesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.MessagesRequestBuilder(rawUrl, RequestAdapter);
        }
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class MessagesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Discord.OpenApiClient.Lobbies.Item.Messages.MessagesRequestBuilder.MessagesRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
