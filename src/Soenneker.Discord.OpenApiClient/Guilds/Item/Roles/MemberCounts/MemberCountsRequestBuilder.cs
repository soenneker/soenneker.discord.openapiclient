...
{
    /// <summary>
    /// Builds and executes requests for operations under \guilds\{guild_id}\roles\member-counts
    /// </summary>
    ...
    public partial class MemberCountsRequestBuilder : BaseRequestBuilder
    {
        ...
        public MemberCountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/guilds/{guild_id}/roles/member-counts", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Discord.OpenApiClient.Guilds.Item.Roles.MemberCounts.MemberCountsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MemberCountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/guilds/{guild_id}/roles/member-counts", rawUrl)
        {
        }
        /// <returns>A <see cref="global::Soenneker.Discord.OpenApiClient.Guilds.Item.Roles.MemberCounts.MemberCountsGetResponse"/></returns>
